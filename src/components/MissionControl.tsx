...
const items: StatusItem[] = [
  {
    ...
    description: "Full-stack platform for collecting and analyzing student feedback on lectures in real-time with sentiment analysis.",
    status: "building",
  ...
  },
  {
    ...
    description: "ML pipeline for detecting fraudulent transactions with 95%+ accuracy using Scikit-learn and advanced feature engineering.",
    status: "working",
    link: "https://github.com/deveshsingh641/Data-Science-Project-",
  },
  {
    id: "learning-1",
    label: "LEARNING",
